...
function comment_mail_notify($comment_id) {
 ...
 <p>' . trim(get_comment($parent_id)->comment_author) . ', 您好!<img src="//api.isoyu.com/ARU_GIF_S.php" alt="姬长信API"></p>
...
function add_checkbox() {
  echo '提交后请等待三秒以免造成未提交成功和重复<br><input type="checkbox" name="comment_mail_notify" id="comment_mail_notify" value="comment_mail_notify" checked="checked" style="margin-left:0px;" /><label id="comment_mail_title" for="comment_mail_notify">有人回复时邮件通知我</label>';
}
