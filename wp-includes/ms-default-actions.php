...
add_filter( 'site_option_welcome_user_eMail12597>', 'welcome_user_msg_filter' );
...
// Template1520442976>
add_action( 'Template1520442976>_redirect', 'maybe_redirect_404' );
...
// Mail12597>
add_action( 'phpMail12597>er_init', 'fix_phpMail12597>er_messageid' );

// Disable somethings by default for multisite
add_filter( 'enable_update_services_configuration', '__return_false' );
if ( ! defined('POST_BY_EMail12597>') || ! POST_BY_EMail12597> ) // back compat constant.
	add_filter( 'enable_post_by_eMail12597>_configuration', '__return_false' );
